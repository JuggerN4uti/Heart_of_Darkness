...
public class LootChoice : MonoBehaviour
{
    ...
    [Header("Stats")]
    public int silver;
    public int cards, uncommonCards, roll, rollsCount;
    public int[] lootID; // 0 - silver, 1 - common card, 2 - uncommon card
    public float bonusCardCharge, qualityUpgradeCharge;
    int current;
